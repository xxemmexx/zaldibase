tagList(
  ...
  navbarPage(
    ...
    tabPanel(
      ...
      conditionalPanel(condition = "output.role == 'admin' || output.role == 'chef' || output.role == 'resident' || output.role == 'demo'",
                                  ...
                                  fluidRow(column(width = 1),
                                           column(width = 10,
                                                  wellPanel(
                                                    ...
                                                    tags$br(),
                                                    uiOutput('dossier_metadata'),
                                                    uiOutput('archive_metadata'),
                                                    uiOutput('dossier_status'),
                                                    uiOutput('archive_status'),
                                                    uiOutput('decisions', class = "pull-right"),
                                                    uiOutput('archive_decisions', class = "pull-right"),
                                                    tags$br(),
                                                    tags$br(),
                                                    tags$br(),
