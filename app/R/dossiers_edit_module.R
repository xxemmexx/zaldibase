                 ...
                 edit_dossier_dat <- reactive({
                   ...
                   out <- list(uid = deliverUID(hold),
                               data = list("patient_inconnu" = ifelse(input$patient_inconnu, 1, 0),
                                           ...
                                           "comorb_metabolique" = input$comorb_metabolique,
                                           "comorb_cardiovasculaire" = input$comorb_cardiovasculaire,
                                           "comorb_renale" = input$comorb_renale,
                                           "comorb_hepatique" = input$comorb_hepatique,
                                           "comorb_oncologique" = input$comorb_oncologique,
                                           "comorb_neurologique" = input$comorb_neurologique,
                                           "comorbidite_1" = input$comorbidite_1,
                                           "comorb_1" = input$comorb_1,
                                           "comorbidite_2" = input$comorbidite_2,
                                           "comorb_2" = input$comorb_2,
