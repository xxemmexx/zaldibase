                       ...
                       modalDialog(
                         div(style = "padding: 30px;",
                             fluidRow(
                               ...
                               tags$br(),
                               tags$br(),
                               HTML("<h5 style=text-align:left;><b>Observations du staff</b></h5>"),
                               tags$br(),
                               writeExplanation(hold$explication),
                               tags$br(),
                               tags$br(),
                               HTML("<h5 style=text-align:left;><b>Syndrome inflammatoire ou infectieux actif</b></h5>"),
                               tags$br(),
                               writeSyndromeInflammatoire(hold$syndrome),
                               tags$br(),
                               tags$br(),
                               tags$hr(),
                               tags$br(),
                               column(width = 6,
                                      dateInput(ns("date_rendezvous"),
                                                'Date (AAAA-MM-DD)',
                                                value = ifelse((str_trim(hold$date_rendezvous) == "1970-01-01" | is.na(hold$date_rendezvous)), 
